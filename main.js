...
console.log(typeof (transferencia.fecha));
...
function depositar(dinero_en_cta){    
    ...
    dinero_en_cta = dinero_en_cta + deposito;
...
function actividad (){
    ...
    transferencias.forEach (transferencia => {
        ...
        let opc_actividad = prompt ("¿Desea ver la última actividad?\n 1. Si\n 2. No"); 
            if (opc_actividad === "1"){
                let ult_actividad = transferencias.filter ( (transferencia) => transferencia.fecha > 2023/10/7)
                let volver = alert 
                ("Alias: " + ult_actividad.alias + "\n" +
                "CVU: " + ult_actividad.CVU + "\n" +
                "Fecha: " + ult_actividad.fecha + "\n" +
                "Monto: " +  ult_actividad.monto + "\n" +
                "\n ¿Desea volver al inicio?")

                let transferenciaVista = true;
